...
def get_data():
    data_list = []
    # with open(r"C:\Users\86176\Desktop\sms\data_sms\data_yaml.yaml", "r") as f:
    # with open("data_yaml.yaml","r") as f:
	with open(os.getcwd()+os.sep+"data_sms"+os.sep+"data_yaml.yaml") as f:
...
class TestSendMessage:
    ...
    def test_send_message(self, text, expect):
        #  发送内容
        ...
        # 断言
        assert expect in send_data_list
